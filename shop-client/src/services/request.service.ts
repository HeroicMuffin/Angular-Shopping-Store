...
export class RequestService {
  ...
  public login(userCredentials: any): Promise<any> {
    return this.http.post<any>(this.baseUrl + "login", userCredentials).toPromise();
  }

  public checkAvailability(userCredentials: any): Promise<any> {
    return this.http.post<any>(this.baseUrl + "checkAvailabilty", userCredentials).toPromise();
  }

  public register(userToAdd: any): Promise<any> {
    return this.http.post<any>(this.baseUrl + "register", userToAdd).toPromise();
  }

  public addProduct(prodToAdd: any): Promise<any> {
    return this.http.post<any>(this.baseUrl + "addProduct", prodToAdd).toPromise();
  }

  public editProduct(prodToEdit: any): Promise<any> {
    return this.http.post<any>(this.baseUrl + "editProduct", prodToEdit).toPromise();
  }

  public addShipment(shipDate: any): Promise<any> {
    return this.http.post<any>(this.baseUrl + "addShipment", shipDate).toPromise();
  }
}